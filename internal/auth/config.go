...
// Office web Copilot first-party client.
...
// Set M365_REDIRECT_URI to a registered nativeclient URI when the configured
// application does not allow the loopback callback.
